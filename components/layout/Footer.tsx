...
export function Footer() {
    ...
    return (
        <footer className="bg-forest text-forest-beige py-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            <Button variant="ghost" size="icon" className="rounded-full text-[#7A8072] hover:text-forest-beige hover:bg-forest-card">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/explore" className="text-[#7A8072] hover:text-forest-beige transition-colors">Explore Projects</Link></li>
                            <li><Link href="/communities" className="text-[#7A8072] hover:text-forest-beige transition-colors">Communities</Link></li>
                            <li><Link href="/events" className="text-[#7A8072] hover:text-forest-beige transition-colors">Events</Link></li>
                            <li><Link href="/about" className="text-[#7A8072] hover:text-forest-beige transition-colors">About Us</Link></li>
                            <li><Link href="/contact" onClick={handleComingSoon} className="text-[#7A8072] hover:text-forest-beige transition-colors">Contact</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/register" className="text-[#7A8072] hover:text-forest-beige transition-colors">Create Organization</Link></li>
                            <li><Link href="/features" onClick={handleComingSoon} className="text-[#7A8072] hover:text-forest-beige transition-colors">Features</Link></li>
                            <li><Link href="/resources" onClick={handleComingSoon} className="text-[#7A8072] hover:text-forest-beige transition-colors">Resources</Link></li>
                            <li><Link href="/partnership" onClick={handleComingSoon} className="text-[#7A8072] hover:text-forest-beige transition-colors">Partnership</Link></li>
                        </ul>
                    </div>
                </div>
