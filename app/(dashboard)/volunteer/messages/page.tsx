...
const CONTACTS = [
  { id: 1, name: "Ocean Care ID", role: "Organization", unread: 2, isOnline: true },
  { id: 2, name: "Tech For All", role: "Organization", unread: 0, isOnline: false },
  { id: 3, name: "Admin JALA", role: "Support", unread: 0, isOnline: true },
];

const INITIAL_CHATS: Record<number, any[]> = {
  1: [
    { id: 1, sender: "Ocean Care ID", isMe: false, text: "Hi there! Welcome to the Coastal Cleanup Initiative.", time: "10:15 AM" },
    { id: 2, sender: "Me", isMe: true, text: "Hello! Thank you. I was wondering if we need to bring our own gloves?", time: "10:20 AM" },
    { id: 3, sender: "Ocean Care ID", isMe: false, text: "No need, we will provide the tools including gloves and trash bags. Just bring a water bottle!", time: "10:30 AM" },
  ],
  2: [
    { id: 1, sender: "Tech For All", isMe: false, text: "Looking forward to your session!", time: "Yesterday" },
  ],
  3: [
    { id: 1, sender: "Admin JALA", isMe: false, text: "Your profile has been verified.", time: "Mon" },
  ]
};
