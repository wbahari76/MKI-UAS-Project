  ...
  return (
    <div className="space-y-8 pb-20">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-forest-beige tracking-tight">My Events</h1>
          <p className="text-forest-muted mt-1">Manage your upcoming and past volunteer activities.</p>
        </div>
