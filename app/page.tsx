            ...
            <div className="container-custom">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/register?role=volunteer" className="text-slate-400 hover:text-white transition-colors">Sign Up as Volunteer</Link></li>
                            ...
                            <li><Link href="/volunteer/guide" className="text-slate-400 hover:text-white transition-colors">Volunteer Guide</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/register?role=organization" className="text-slate-400 hover:text-white transition-colors">Create Organization</Link></li>
                            <li><Link href="/organization/features" className="text-slate-400 hover:text-white transition-colors">Features</Link></li>
                            <li><Link href="/organization/resources" className="text-slate-400 hover:text-white transition-colors">Resources</Link></li>
                            <li><Link href="/organization/partnership" className="text-slate-400 hover:text-white transition-colors">Partnership</Link></li>
                        </ul>
                    </div>
                </div>
